          ...
          <div className="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between">
            <div className="flex items-center gap-6">
              ...
              <nav className="hidden md:flex items-center gap-0.5">
                ...
                <Link href="/jiying/studio" className="px-3 py-1.5 text-sm text-white/40 hover:text-white transition-colors rounded-lg hover:bg-white/[0.04]">📚 漫剧一键生成</Link>
            ...
            <div className="flex items-center gap-2">
              ...
              <details className="md:hidden relative">
                ...
                <div className="absolute right-0 top-full mt-2 w-48 bg-[#0f1929] border border-white/[0.06] rounded-2xl p-2 z-50 backdrop-blur-xl shadow-2xl">
                  ...
                  <Link href="/jiying/studio" className="block px-3 py-2 rounded-xl text-sm text-white/50 hover:text-white hover:bg-white/[0.04]">📚 漫剧一键生成</Link>
