  ...
  return (
    <div className="min-h-screen bg-[#0C0C14]">
      ...
      <section className="relative overflow-hidden pt-20 pb-16">
        <div className="min-h-screen bg-[#0C0C14]">me="absolute inset-0 bg-gradient-to-br from-[#F59E0B]/3 via-transparent to-[#F97316]/3 animate-gradient" style={{backgroundSize:'200% 200%'}} />
        <div className="min-h-screen bg-[#0C0C14]">me="absolute top-[-20%] left-[-10%] w-[60%] h-[70%] rounded-full bg-[#F59E0B]/8 blur-[150px]" />
        <div className="min-h-screen bg-[#0C0C14]">me="absolute bottom-[-20%] right-[-10%] w-[50%] h-[60%] rounded-full bg-[#F97316]/4 blur-[150px]" />
        <div className="min-h-screen bg-[#0C0C14]">me="relative max-w-6xl mx-auto px-6 text-center">
          <div className="min-h-screen bg-[#0C0C14]">me="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#18182A] border border-[#F59E0B]/15 text-xs text-[#F59E0B] mb-6 shadow-sm">
          ...
          <div className="min-h-screen bg-[#0C0C14]">me="flex flex-wrap justify-center gap-4">
      ...
      <section className="max-w-6xl mx-auto px-6 -mt-8 relative z-10">
        ...
        <div className="min-h-screen bg-[#0C0C14]">me="grid grid-cols-2 md:grid-cols-4 gap-3">
          {[
            ...
            <Link key={s.title} href={s.h}
              ...
              <div className="min-h-screen bg-[#0C0C14]">me="text-2xl mb-2">{s.t}</div>
              <div className="min-h-screen bg-[#0C0C14]">me="text-sm font-semibold bg-gradient-to-r from-[#E8E8F0] via-[#F59E0B] to-[#F97316] bg-clip-text text-transparent bg-[length:200%_100%] animate-gradient group-hover:from-[#F59E0B] group-hover:via-[#F97316] group-hover:to-[#F59E0B]">{s.title}</div>
              <div className="min-h-screen bg-[#0C0C14]">me="text-[10px] text-[#5A5A72] mt-0.5">{s.desc}</div>
            </Link>
          ))}
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-6 py-24">
        <div className="min-h-screen bg-[#0C0C14]">me="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="min-h-screen bg-[#0C0C14]">me="glass-card p-8">
          ...
          <div className="min-h-screen bg-[#0C0C14]">me="glass-card p-8 border-[#F59E0B]/15 bg-[#F59E0B]/[0.04]">
      ...
      <section className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="min-h-screen bg-[#0C0C14]">me="glass-card overflow-x-auto">
        ...
        <div className="min-h-screen bg-[#0C0C14]">me="grid grid-cols-2 md:grid-cols-4 gap-3">
          {[
            ...
            <div key={c.n} className="glass-card p-6 text-center hover:shadow-hover transition-all relative">
              ...
              <div className="min-h-screen bg-[#0C0C14]">me="text-sm font-medium text-[#5A5A72]">{c.n}</div>
              <div className="min-h-screen bg-[#0C0C14]">me="mt-2"><span className="text-2xl font-extrabold text-[#E8E8F0]">{c.p}</span><span className="text-xs text-[#5A5A72] ml-0.5">{c.u}</span></div>
              <div className="min-h-screen bg-[#0C0C14]">me="text-xs text-[#5A5A72] mt-1.5">{c.d}</div>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="max-w-3xl mx-auto px-6 py-10">
        ...
        <div className="min-h-screen bg-[#0C0C14]">me="space-y-2">
          {FAQ.map((item, i) => (
            <details key={i} className="glass-card overflow-hidden group">
              ...
              <div className="min-h-screen bg-[#0C0C14]">me="px-5 pb-4 text-xs text-[#9898B0] leading-relaxed border-t border-[#2A2A38] pt-3">{item.a}</div>
            </details>
          ))}
        </div>
      </section>
      ...
      <section className="max-w-3xl mx-auto px-6 text-center pt-8">
        <div className="min-h-screen bg-[#0C0C14]">me="glass-card p-10">
          <div className="min-h-screen bg-[#0C0C14]">me="text-4xl mb-4">🎬</div>
        ...
        <div className="min-h-screen bg-[#0C0C14]">me="mt-6">
